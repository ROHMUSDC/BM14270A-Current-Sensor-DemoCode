# BM14270A Demo Code Repository
* Arduino Example code for ROHM Semiconductor's BM14270A

----
### Description: 
* This Demo code is meant for Arduino platform boards and prints the current value (decimal) to the serial port at 9600 baud and has resolution of 0.1 amps.  
* It has easy to modify variables for Offset and Gain and is set up for 16 averages, and prints every 500 milliseconds.  
* Using the Arduino serial monitor screen makes it real easy to evaluate our BM14270A EVK.

----
### Additional Information: 
* IC Product Page - https://www.rohm.com/products/sensors-mems/current-sensor-ics/bm14270amuv-lb-product
* IC Datasheet - https://fscdn.rohm.com/en/products/databook/datasheet/ic/sensor/current_sensor/bm14270amuv-lb-e.pdf
